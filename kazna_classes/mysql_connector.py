...
class Mysql_connector:
    ...
    def insert_sql_query(type:str, source:str, column:str, value:str):
        cnx = mysql.connector.connect(
            ...
            port=str(config("DB_PORT")),  # the port defined in the docker-compose.yaml file
            user='root',  # default username for the MySQL container
            password=str(config("DB_PASSWD")),  # the password defined in the docker-compose.yaml file
        ...
        cursor.execute('SELECT cash_euro_with_me, cash_euro_not_with_me, cash_$_with_me, cash_$_not_with_me, card_euro, card_$, cash_RUB_not_with_me, card_RUB, bitcoin, ethir, shares_RUB from kazna_mysql_table ORDER BY id DESC LIMIT 1;')
        ...
        cursor.execute('INSERT INTO kazna_mysql_table (cash_euro_with_me, cash_euro_not_with_me, cash_$_with_me, cash_$_not_with_me, card_euro, card_$, cash_RUB_not_with_me, card_RUB, bitcoin, ethir, shares_RUB) VALUES ' + str(results) + ';')
