...
CREATE TABLE debts_loans_table(id int AUTO_INCREMENT PRIMARY KEY, date TIMESTAMP DEFAULT CURRENT_TIMESTAMP, Debt_or_Loan_type VARCHAR(30), Type VARCHAR(30), Debt_Loan_sum FLOAT(10, 2), Details VARCHAR(30), Person VARCHAR(30), CHECK (Type = 'Money' OR Type = 'Other'));
